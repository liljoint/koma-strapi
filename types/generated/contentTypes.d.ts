...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    productAvailable: Attribute.Boolean;
    workArea: Attribute.Relation<
      'api::product.product',
      'oneToOne',
      'api::work-area.work-area'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiRequestOrderRequestOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tip: Attribute.Decimal;
    isCompleted: Attribute.Boolean;
    partialPayment: Attribute.Decimal;
    vouchers: Attribute.JSON;
...
export interface ApiTableTable extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tableAvailable: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiWorkAreaWorkArea extends Schema.CollectionType {
  collectionName: 'work_areas';
  info: {
    singularName: 'work-area';
    pluralName: 'work-areas';
  ...
  attributes: {
    ...
    areaDescription: Attribute.String;
    areaPrinters: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
